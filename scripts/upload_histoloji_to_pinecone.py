...
target_dir = r"C:\Users\FURKAN\Desktop\DUS\üretim\Histoloji"
namespace = "histoloji"
...
print(f"Found {len(pdf_files)} PDF files in Histoloji. Extracting text...")
...
for file in pdf_files:
    ...
    for i, chunk in enumerate(chunks):
        safe_id = f"histoloji-{uuid.uuid4().hex}"
        record = {
            "id": safe_id,
            "text": chunk,
            "source": file,
