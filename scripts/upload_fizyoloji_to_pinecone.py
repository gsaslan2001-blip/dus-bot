...
target_dir = r"C:\Users\FURKAN\Desktop\DUS\üretim\Fizyo ünite pdf"
namespace = "fizyoloji"
...
print(f"Found {len(pdf_files)} PDF files in Fizyoloji. Extracting text...")
...
for file in pdf_files:
    ...
    for i, chunk in enumerate(chunks):
        safe_id = f"fizyoloji-{uuid.uuid4().hex}"
        record = {
            "id": safe_id,
            "text": chunk,
            "source": file,
